...
public class RavenLazyRegistryComplexWrapper<T extends IForgeRegistryEntry<T>, R extends IForgeRegistryEntry<R>> {
    private final DeferredRegister<T> _internalRegistry;
    private final DeferredRegister<R> __internalRegistry;

    public RavenLazyRegistryComplexWrapper(String modId, IForgeRegistry<T> registryA, IForgeRegistry<R> registryB) {
    ...
    public <E extends T, V extends R, W extends RavenRegistryComplexWrapper<E, V>> W register(
